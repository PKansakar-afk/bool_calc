...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.output_lcd2 = QLCDNumber(self.centralwidget)
        self.output_lcd2.setObjectName(u"output_lcd2")
        self.output_lcd2.setGeometry(QRect(70, 100, 141, 23))
        self.output_lcd2.setSmallDecimalPoint(True)
        self.output_lcd2.setDigitCount(9)
        self.output_lcd2.setSegmentStyle(QLCDNumber.SegmentStyle.Flat)
        self.output_lcd2.setProperty(u"value", 0.000000000000000)
        self.output_lcd2.setProperty(u"intValue", 0)
        ...
        self.output_lcd.setGeometry(QRect(260, 160, 64, 23))
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 408, 33))
